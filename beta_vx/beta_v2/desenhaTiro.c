...
void desenhaTiroBoss()
{
    ...
    glTranslatef(tiro_boss_x, AQUILES_Y, 0);

    glBegin(GL_TRIANGLE_FAN);

        glTexCoord2f(quadro_tiro_boss[0], quadro_tiro_boss[2]);
        glVertex2f(-AQUILES_LARG/2, -AQUILES_ALT/2);

        glTexCoord2f(quadro_tiro_boss[1], quadro_tiro_boss[2]);
        glVertex2f( AQUILES_LARG/2, -AQUILES_ALT/2);

        glTexCoord2f(quadro_tiro_boss[1], quadro_tiro_boss[3]);
        glVertex2f( AQUILES_LARG/2,  AQUILES_ALT/2);

        glTexCoord2f(quadro_tiro_boss[0], quadro_tiro_boss[3]);
        glVertex2f(-AQUILES_LARG/2,  AQUILES_ALT/2);
