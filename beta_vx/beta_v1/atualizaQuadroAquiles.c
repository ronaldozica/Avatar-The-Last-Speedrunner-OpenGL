...
void atualizaQuadroAquiles()
{
	if(pulo == 0)
	{
		...
		else
		{
				...
				switch(flag_aquiles)
				{
					...
					case 2:
						...
						if(cont_frames_aquiles < VELOCIDADE_AQUILES)
						{
							if(cont_frames_aquiles == 0)
							{
								quadro_aquiles[0] = 0.044;
								quadro_aquiles[1] = 0.088;
							}
					...
					case 3:
						...
						if(cont_frames_aquiles < VELOCIDADE_AQUILES)
						{
							if(cont_frames_aquiles == 0)
							{
								quadro_aquiles[0] = 0.088;
								quadro_aquiles[1] = 0.133;
							}
					...
					case 4:
						...
						if(cont_frames_aquiles < VELOCIDADE_AQUILES)
						{
							if(cont_frames_aquiles == 0)
							{
								quadro_aquiles[0] = 0.133;
								quadro_aquiles[1] = 0.178;
							}
			...
			{
				quadro_aquiles[0] = 0.178;
				quadro_aquiles[1] = 0.223;
			}
		}
	}
		...
		switch(flag_aquiles)
		{
			...
			case 9:
				...
				if(cont_frames_aquiles < DELAY_PULO)
				{
					if(cont_frames_aquiles == 0)
					{
						quadro_aquiles[0] = 0.594;
						quadro_aquiles[1] = 0.649;
					}
			...
			case 10:
				...
				if(cont_frames_aquiles < DELAY_PULO)
				{
					if(cont_frames_aquiles == 0)
					{
						quadro_aquiles[0] = 0.684;
						quadro_aquiles[1] = 0.740;
					}
			...
			case 11:
				...
				if(cont_frames_aquiles < DELAY_PULO)
				{
					if(cont_frames_aquiles == 0)
					{
						quadro_aquiles[0] = 0.775;
						quadro_aquiles[1] = 0.831;
					}
			...
			case 12:
				...
				if(cont_frames_aquiles < DELAY_PULO)
				{
					if(cont_frames_aquiles == 0)
					{
						quadro_aquiles[0] = 0.866;
						quadro_aquiles[1] = 0.922;
					}
